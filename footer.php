                    ...
                    <div class="row">
                        <div class="col-md-4  col-sm-6 footer-bottom-widget">
                            <div class="section-heading">
                                ...
                                <div class="head-img">
                                    <img src="<?php echo $fronturl; ?>/asset/images/header.png" alt="header-img">
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 footer-bottom-widget">
                            ...
                            <div class="footer-widget">
                                <?php
                                    if ($_POST && isset($_POST['name']) && $_POST['email'] && $_POST['text']) {
                                        if (!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['text'])) {
                                            ...
                                            $res = mail( $gen[5], 'New Submission From MLM', $msg);
                                            if ($res) { ?>
                                ...
                                ?>
                                <form action="<?php echo $fronturl; ?>/contact.php" method="POST">
    ...
    <!--end-scroll- up-->
    <script type='text/javascript' src="<?php echo $fronturl; ?>/asset/js/plugins.js"></script>
    <script type='text/javascript' src="<?php echo $fronturl; ?>/asset/js/colors.js"></script>
    <script type='text/javascript' src="<?php echo $fronturl; ?>/asset/js/custom.js"></script>
