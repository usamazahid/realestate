...
<span class="title">Booking List</span><span class="arrow"></span></a>

<ul class="sub-menu">
<li class="nav-item"><a href="bookingrequests.php" class="nav-link"><i class="fa fa-desktop"></i> Pending Request</a></li>
<li class="nav-item"><a href="bookinglog.php" class="nav-link"><i class="fa fa-desktop"></i> View Log</a></li>
...
<li class="nav-item"><a href="addusers.php" class="nav-link"><i class="fa fa-desktop"></i> Add Users </a></li>
