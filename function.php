<?php
$domain = "http://localhost/real"; ////// Root of Domain
$baseurl = "http://localhost/real/member"; ////// Member Panel URL
$adminurl = "http://localhost/real/admin"; ////// Admin Panel URL
$fronturl = "http://localhost/real"; ////// Admin Panel URL
